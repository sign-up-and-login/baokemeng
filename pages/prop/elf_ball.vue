					...
					<view class="scroll">
						...
						<view class="log_all">
							...
							<view class="log">
								...
								<view class="log_input">
									<input type="text" v-model="num" maxlength="20" placeholder="请填写精灵球数额" />
								</view>
							</view>
							<view class="log">
								<view class="h1">
						...
						<view class="prompt">
							...
							<view class="prompt_content">
								<view class="prompt_text"><text class="hh">●</text><text>账户余额必须在转账后至少剩余100，转账数额必须以50倍数。</text></view>
								<view><text class="hh">●</text><text>例子：200转100剩100.</text></view>
							</view>
						</view>
						<view class="prompt">
							<view class="h2">
							...
							<view class="prompt_content">
								<view class="prompt_text"><text class="hh">●</text><text>向平台购买，添加客服微信</text></view>
...
<script>
	...
	export default {  
		...
		methods:{
			...
			submit(id){
			if(this.num>this.card_list[0].balance){
				uni.showToast({
					icon:'none',
					title:'请输入正确的数量'
				})
...
<style>
	...
	.box2{
		...
		margin-top: 20rpx;
		border-radius: 10rpx;
		background: url(../../static/index/pokes.png) 10rpx center no-repeat;
		background-size: 50rpx 100%;
		background-color: #AAAAAA;
	}
	.number{
