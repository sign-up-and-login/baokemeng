				...
				<view class="details">
					...
					<view class="title">
						<view class="title_logo">
							<image src="../../static/index/intro-income.png" mode="widthFix"></image>
						</view>
						<text>动态收益</text>
					</view>
					<!-- 个人数据 -->
						...
						<view class="record">
							<view class="record_content">
								<view class="record_pic">
									<image src="../../static/index/egg.png" mode="widthFix"></image>
								</view>
								<view class="record_data">
									<view class="li">时间：1 ~ 7 天 </view>
									<view class="li">价值：100 - 300美金</view>
									<!-- <view class="li">买价：176.31 美金</view> -->
									<view class="price">
										<view class="price_num">
											<text class="h2">支付数额：</text>
											<text class="h3">100美金</text>
										</view>
							...
							<view class="record_bg">
								<image src="../../static/index/pack-yellow.png" mode="scaleToFill"></image>
							</view>
						</view>
						<!--  -->
						<view class="record">
...
<style>
	...
	.box2 {
		...
		margin-top: 20rpx;
		border-radius: 10rpx;
		background: url(../../static/index/intro.png) 10rpx center no-repeat;
		background-size: 50rpx 100%;
		background-color: #AAAAAA;
	}
	...
	.price_btn{
		...
		font-size: 30rpx;
		font-weight: bold;
		background: url(../../static/index/dabaoed.png) center center no-repeat;
