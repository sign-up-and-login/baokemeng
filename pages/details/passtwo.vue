<template>
	<view class="">
		...
		<view class="content">
			<view class="specific">
				<!-- 返回键 -->
				<view class="back" @click="jump('/pages/prop/safety')">
					...
					<view class="scroll">
						...
						<view class="title">
							<view class="title_logo">
								<image src="../../static/index/center.png" mode="widthFix"></image>
							</view>
							<text>更改二级密码</text>
						</view>
						...
						<view class="log_all">
							<view class="log">
								...
								<view class="log_input">
									<input type="text" maxlength="20" placeholder="请填写二级密码" />
								</view>
							</view>
							<view class="log">
								<view class="h1">
								...
								<view class="log_input">
									<input type="text" maxlength="20" placeholder="请填写新的二级密码" />
								</view>
							</view>
							<view class="log">
								<view class="h1">
							...
							<!-- 按钮 -->
							<view class="btn">
								<view class="button" @click="jump('/pages/prop/safety')">
									提交
								</view>
							</view>
						</view>
